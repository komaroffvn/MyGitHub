...
begin
AddProductionForm.Caption:='Добавить продукцию на склад';
Form1.ProductionADOQuery2.Append;
AddProductionForm.DBEdit4.ReadOnly:=false;
AddProductionForm.Label1.Caption:='Наименование продукции';
...
begin
  Form2.DBGrid1.DataSource.DataSet.Close; //Обновление формы Вся продукция после добавления или удаления продукции
...
//Удалить продукцию через меню
procedure TForm1.BtnDeleteClick(Sender: TObject);
begin
 Form1.ProductionADOQuery2.Delete;
end;

//Удаление прдукции через значёк
procedure TForm1.SpeedButton3Click(Sender: TObject);
begin
  Form4.Show;
end;

//Передача продукции, списание
...
//Изменение продукции через значёк
procedure TForm1.SpeedButton2Click(Sender: TObject);
begin
  AddProductionForm.Caption:='Изменить';
  AddProductionForm.DBEdit4.ReadOnly:=true;
  AddProductionForm.Label1.Caption:='Наименование продукции изменить нельзя!';
  AddProductionForm.Label1.Color:=clRed;
  AddProductionForm.Show;
end;

//Добавление продукции через меню
...
//Увеличить шрифт продукции
procedure TForm1.Button2Click(Sender: TObject);
begin
  Form1.DBGrid2.Font.Height:=-16;
end;
//Уменьшить шрифт продукции
...
//Связь таблиц Категория и Приход продукции
...
//Связь таблиц Приход продукции и Расход продукции
...
//Изменение продукции через меню
